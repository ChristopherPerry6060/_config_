...
vim.keymap.set('n', '<leader>fws', builtin.lsp_workspace_symbols, {}) -- Find Workspace Symbols
vim.keymap.set('n', '<leader>ftd', builtin.lsp_type_definitions, {}) -- Find Type Definitions
